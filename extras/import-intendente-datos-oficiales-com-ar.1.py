...
file_csv = open('intendente-cordoba-2019-provisorio-por-mesas.csv', 'w')
fieldnames = None
...
for data in json_data:
    ...
    if data['clase_ubicacion'] == 'Mesa':
        ...
        if ubicaciones[1] != '1':  # NO ES CORDOBA CIUDAD
            continue
        url_gobernador = 'https://datosoficiales.com.ar/resultados/{}/{}/{}/{}/{}/INT.json'.format(ubicaciones[0], ubicaciones[1], ubicaciones[2], ubicaciones[3], ubicaciones[4])
