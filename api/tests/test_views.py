...
def test_listar_distritos(admin_client):
    url = reverse('distritos')
...
def test_listar_secciones(admin_client):
    url = reverse('secciones', kwargs={'id_distrito': 1})
...
def test_listar_circuitos(admin_client):
    url = reverse('circuitos', kwargs={'id_seccion': 1})
...
def test_listar_mesas(admin_client):
    url = reverse('mesas', kwargs={'id_circuito': 1})
