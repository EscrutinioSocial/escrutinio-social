...
def test_mesa_siguiente_categoria(db):
    ...
    VotoMesaReportadoFactory(mesa=m1, categoria=e1, opcion=e1.opciones.first(), votos=10)
    assert m1.siguiente_categoria_sin_carga() == e2
    VotoMesaReportadoFactory(mesa=m1, categoria=e2, opcion=e2.opciones.first(), votos=10)
...
def test_con_carga_pendiente_incluye_mesa_con_categoria_sin_cargar(db):
    ...
    VotoMesaReportadoFactory(mesa=m2, categoria=categoria, opcion=categoria.opciones.first(), votos=10)
    VotoMesaReportadoFactory(mesa=m2, categoria=categoria, opcion=categoria.opciones.last(), votos=12)
    ...
    VotoMesaReportadoFactory(mesa=m3, categoria=categoria, opcion=categoria.opciones.first(), votos=20)
    VotoMesaReportadoFactory(mesa=m3, categoria=e2, opcion=e2.opciones.first(), votos=20)
...
def test_con_carga_a_confirmar(db):
    ...
    VotoMesaReportadoFactory(mesa=m2, categoria=e1, opcion=e1.opciones.first(), votos=10)
