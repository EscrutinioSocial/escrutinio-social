...
CSV = Path(settings.BASE_DIR) / 'elecciones/data/2019/paso-nacional/escuelas-testing.csv'
...
#            escuela.electores = int(row['electores']) #no los tenemos aca
            ...
            #tal vez agregar las mesas en otra instancia y solo guardar los valores
                mesa, created = Mesa.objects.update_or_create(numero=mesa_nro,lugar_votacion=escuela,circuito=circuito, electores=350)  # EVITAR duplicados en limpiezas de escuelas y otros
