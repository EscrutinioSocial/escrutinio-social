...
crawl-resultados:
	 wget --recursive --level=100 --convert-links --html-extension --restrict-file-names=windows --no-parent --no-host-directories --directory-prefix=crawl-resultados --span-hosts localhost:8000/elecciones/resultados/2
