...
def test_elegir_acta_mesas_redirige(db, fiscal_client):
    ...
    m1 = IdentificacionFactory(mesa__categoria=[e1], mesa__lugar_votacion__circuito=c).mesa
    e2 = CategoriaFactory()
    m2 = IdentificacionFactory(mesa__categoria=[e1, e2], mesa__lugar_votacion__circuito=c).mesa
...
def test_elegir_acta_prioriza_por_tamaño_circuito(db, fiscal_client):
    ...
    m1 = IdentificacionFactory(mesa__categoria=[e1]).mesa
    m2 = IdentificacionFactory(mesa__categoria=[e1]).mesa
    m3 = IdentificacionFactory(mesa__categoria=[e1]).mesa
...
def test_carga_mesa_redirige_a_siguiente(db, fiscal_client):
    ...
    m1 = IdentificacionFactory(mesa__categoria=[e1, e2]).mesa
