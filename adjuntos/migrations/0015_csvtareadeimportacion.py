    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', model_utils.fields.StatusField(choices=[('pendiente', 'pendiente'), ('en_progreso', 'en progreso'), ('procesado', 'procesado'), ('error', 'error')], default='pendiente', max_length=100, no_check_for_status=True)),
